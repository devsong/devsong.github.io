...
# MySQL数据库设计规范
#### 原地址参见[https://github.com/jly8866/archer/blob/master/src/docs/mysql_db_design_guide.md](https://github.com/jly8866/archer/blob/master/src/docs/mysql_db_design_guide.md)
## 目录
...
[MySQL数据类型存储大小](https://dev.mysql.com/doc/refman/5.7/en/storage-requirements.html)
